      ...
      <Tabs defaultValue="login" className="w-full max-w-md mx-auto">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="font-headline text-2xl flex items-center">
                <LogIn className="mr-2 h-6 w-6 text-primary" />Welcome Back!
              </CardTitle>
              <CardDescription>Sign in to your HydroTrack account</CardDescription>
            </CardHeader>
        ...
        <TabsContent value="register">
          <Card>
            <CardHeader>
              <CardTitle className="font-headline text-2xl flex items-center">
                <UserPlus className="mr-2 h-6 w-6 text-primary" />Create Account
              </CardTitle>
              <CardDescription>Join HydroTrack and start saving water today.</CardDescription>
            </CardHeader>
